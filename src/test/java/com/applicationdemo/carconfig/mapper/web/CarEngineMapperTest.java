...
@ActiveProfiles("test")
@SpringBootTest
class CarEngineMapperTest {

    @Autowired
    private CarEngineMapper mapper;

    @Test
    void toEntity_mapsAllFields() {
        // Arrange
        CarEngineDto dto = new CarEngineDto();
        dto.setModel("V8");
    ...
    void toDto_mapsAllFields() {
        ...
        // Act
        CarEngineDto dto = mapper.toDto(entity);
    ...
    void partialUpdate_updatesOnlyNonNullFields() {
        ...
        CarEngineDto patchDto = new CarEngineDto();
