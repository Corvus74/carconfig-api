...
import com.computacenter.carconfig.dto.order.*;
import com.computacenter.carconfig.dto.web.*;
...
class OrderMapperTest {
    ...
    private static OrderMapper createMapper() {
        ...
        com.computacenter.carconfig.mapper.OrderUserMapper orderUserMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.OrderUserMapper.class);
        com.computacenter.carconfig.mapper.order.OrderStatusMapper orderStatusMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.order.OrderStatusMapper.class);

        // Prepare order sub-mappers and wire their dependencies
        com.computacenter.carconfig.mapper.order.CarEngineOrderMapper carEngineOrderMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.order.CarEngineOrderMapper.class);
        setField(carEngineOrderMapper, "carEngineMapper", carEngineMapper);

        com.computacenter.carconfig.mapper.order.CarColorOrderMapper carColorOrderMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.order.CarColorOrderMapper.class);
        setField(carColorOrderMapper, "carColorMapper", carColorMapper);

        com.computacenter.carconfig.mapper.order.CarRimOrderMapper carRimOrderMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.order.CarRimOrderMapper.class);
        setField(carRimOrderMapper, "carRimMapper", carRimMapper);

        com.computacenter.carconfig.mapper.order.SpecialEquipmentOrderMapper specialEquipmentOrderMapper = Mappers.getMapper(com.computacenter.carconfig.mapper.order.SpecialEquipmentOrderMapper.class);
